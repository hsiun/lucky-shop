...
<body><!------------------------------head------------------------------>
<%@ include file="heaer.jsp" %>

<!-----------------address------------------------------->
<div class="address">
    <div class="wrapper clearfix"><a href="index.jsp">首页</a><span>/</span><a
            href="flowerDer.html">装饰摆件</a><span>/</span><a href="proList.jsp">干花花艺</a><span>/</span><a href="#"
...
<div class="detCon">
    <div class="proDet wrapper">
        <div class="proCon clearfix">
            <div class="proImg fl"><img class="det" src="images/product/${product.productFilename}"/>
                <div class="smallImg clearfix">
                    <img src="images/product/${product.productFilename}" data-src="images/product/${product.productFilename}">
            ...
            <div class="fr intro">
                <div class="title"><h4>${product.productName}</h4>
                    <p>【破损补寄】【适合放室内、卧室、书房、餐桌、办公室、客厅、电视柜等地方】【无理由退换货】【包邮】【${product.productName}】</p><span>￥${product.productPrice}</span></div>
                <div class="proIntro"><p>颜色分类</p>
                    ...
                    <div class="num clearfix"><img class="fl sub" src="img/temp/sub.jpg"><span id="count" class="fl" contentEditable="true">1</span><img
                            class="fl add" src="img/temp/add.jpg">
                        <p class="please fl">请选择商品属性!</p></div>
                </div>
                <div class="btns clearfix">
                    <a href="javascript:shopAdd('${product.id}', 'z')"><p class="buy fl">立即购买</p></a>
                    <a href="javascript:shopAdd('${product.id}', 's')"><p class="cart fr">加入购物车</p></a></div>
            </div>
        </div>
    </div>
</div>
