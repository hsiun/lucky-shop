...
<div class="address">
    <div class="wrapper clearfix"><a href="index.jsp">首页</a><span>/</span><a
            href="flowerDer.html">装饰摆件</a><span>/</span><a href="proList.jsp" class="on">干花花艺</a></div>
</div><!-------------------current---------------------->
<div class="current">
...
<ul class="proList wrapper clearfix">
    ...
    <li><a href="selectprodetail?id=${product.id}">
        <dl>
            <dt><img src="images/product/${product.productFilename}"></dt>
