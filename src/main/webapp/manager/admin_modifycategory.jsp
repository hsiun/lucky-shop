...
<div class="main-wrap">
    ...
    <div class="result-wrap">
        <div class="result-content">
            <form action="admin_modifycategory" method="post" id="myform" name="myform">
                ...
                <table class="insert-tab" width="100%">
                            ...
                            <select class="common-text required" name="parentId">
                                ...
                                <c:forEach var="category" items="${categorys}">
                                    <c:if test="${category.categoryParentId == '0'}">
                                        <c:if test="${cate.categoryParentId == category.id}">
                                            <option value="${category.id}" selected="selected">${cate.categoryName}</option>
                                        </c:if>
                                        <c:if test="${cate.categoryParentId != category.id}">
                    ...
                    <tr>
                        <th>分类名：</th>
                        <td><input class="common-text" name="name" size="50" type="text" value="${cate.categoryName}"></td>
                    </tr>
