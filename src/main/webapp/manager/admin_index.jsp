        ...
        <div class="result-wrap">
            ...
            <div class="result-content">
                <div class="short-wrap">
                    <a href="admin_insert.jsp"><i class="icon-font">&#xe001;</i>新增作品</a>
                    <a href="admin_insert.jsp"><i class="icon-font">&#xe005;</i>新增博文</a>
                    <a href="admin_insert.jsp"><i class="icon-font">&#xe048;</i>新增作品分类</a>
                    <a href="admin_insert.jsp"><i class="icon-font">&#xe041;</i>新增博客分类</a>
