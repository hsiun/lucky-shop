    ...
    <div class="wrapper clearfix">
        ...
        <ul class="clearfix" id="bott">
            ...
            <li><a href="flowerDer.html">装饰摆件</a>
                <div class="sList2">
                    <div class="clearfix"><a href="proList.jsp">干花花艺</a><a href="vase_proList.html">花瓶花器</a></div>
                </div>
            </li>
    ...
    <div class="table wrapper">
        ...
        <div class="th">
            ...
            <div class="pro clearfix"><label class="fl"><input type="checkbox"/><span></span></label><a class="fl"
                                                                                                        href="#">
                <dl class="clearfix">
                    <dt class="fl"><img width="120" height="120" src="images/product/${cart.cartPFilename}"></dt>
                    <dd class="fl"><p>${cart.cartPName}</p>
                        <p>颜色分类:</p>
                        <p>白色瓷瓶+白色串枚</p></dd>
                </dl>
            </a></div>
            <div class="price">￥${cart.cartPPrice}</div>
            <div class="number"><p class="num clearfix">
                <img class="fl sub" src="img/temp/sub.jpg">
                <span class="fl" cartId="${cart.id}">${cart.cartQuantity}</span>
                <img class="fl add" src="img/temp/add.jpg"></p></div>
            <div class="price sAll">${cart.cartPPrice * cart.cartQuantity}</div>
